          ...
          if (isTouch & joyStickMovement == Vector2.zero)
          {
             ...
             */
               ...
               if (swipeDelta.y != 0)
               {
                    ...
                    //BoneToRotate.transform.rotation = Quaternion.Euler(BoneToRotate.transform.rotation.eulerAngles.x, BoneToRotate.transform.rotation.eulerAngles.y, clampedRotation);
               }
